...
##### *Mr. Klabjan is informed that the attribute picked in Problem 6 actually contains outliers. Calculate the average μ and standard deviation σ of the selected attribute. Create a new data set after removing observa- tions that is outside of the range [μ − 3σ, μ + 3σ] and name the data set as redwine2. Print out the dimension of redwine2 to know how many observations are removed.*
